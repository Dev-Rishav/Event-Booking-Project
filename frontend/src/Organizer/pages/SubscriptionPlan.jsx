...
// import { resetSubscription } from '../../redux/slices/adminslice/adminSlice'
// import axios from 'axios';
// import { FaCheck, FaArrowLeft, FaCrown } from 'react-icons/fa';
// import Cookies from 'js-cookie';
...
//                 <p className="text-yellow-700">Plan not found</p>
//             </div>
//         );
//     }
...
//             >
//                 <FaArrowLeft className="mr-2" /> Back to Subscription Plans
//             </button>

//             <div className="bg-white rounded-lg shadow-md overflow-hidden">
//                 <div className={`p-6 ${plan.plan_name === 'Enterprise' ? 'bg-purple-600' : 'bg-blue-600'} text-white`}>
//                     <div className="flex justify-between items-start">
//                         <div>
//                             <h1 className="text-2xl font-bold mb-2">
//                                 {plan.plan_name} Plan
//                                 {plan.plan_name === 'Enterprise' && (
//                                     <FaCrown className="inline-block ml-2 text-yellow-300" />
//                                 )}
//                             </h1>
...
//                                     <span>{plan.max_events === 9999 ? 'Unlimited' : plan.max_events} events per month</span>
//                                 </li>
//                                 <li className="flex items-start">
//                                     <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
//                                     <span>{plan.duration_days}-day subscription period</span>
//                                 </li>
//                                 <li className="flex items-start">
//                                     <FaCheck className="text-green-500 mt-1 mr-2 flex-shrink-0" />
...
//                                     When you subscribe to the {plan.plan_name} plan:
//                                 </p>
//                                 <ul className="list-disc list-inside text-gray-600 space-y-2">
//                                     <li>Your subscription will be active immediately</li>
//                                     <li>You'll be able to create up to {plan.max_events === 9999 ? 'unlimited' : plan.max_events} events</li>
//                                 </ul>
//                             </div>
//                         </div>
//                     </div>
...
//                             onClick={handleSubscribe}
//                             disabled={isSubscribing}
//                             className={`w-full md:w-auto px-6 py-3 rounded-lg font-medium ${plan.plan_name === 'Enterprise'
