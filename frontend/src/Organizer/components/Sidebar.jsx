...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { name: "Feedback & Reviews", path: "/organizer/feedback-reviews", icon: <FaStar /> },
    { name: "Notifications", path: "/organizer/notifications", icon: <FaBell /> },
  ...
  return (
    <>
      ...
      <div className="bg-gray-900 text-white fixed top-0 left-0 w-full h-16 flex justify-between items-center px-6 shadow-md z-50">
        <h1 className="text-xl font-bold ml-16">Organizer Dashboard</h1>
        <button
